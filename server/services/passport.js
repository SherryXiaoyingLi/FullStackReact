...
passport.use(
    new GoogleStrategy(
        ...
        async (accessToken, refreshToken, profile, done)=>{
            ...
            // since this process async op too, need async handling
            // the func will return a user that points to the same underlying structure created
            done(null, user);
                    
            // Mongoose query see if user already exists
            // Every time deal with db, always deal w/ async operation
